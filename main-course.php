...
<div id="content" style="margin-top:7%; width:99%;">
  ...
  $id=$_REQUEST["id"];
  $qry1="select * from semester where DegId='$id'";
  if($res1=mysql_query($qry1))
  {
  	while($data1=mysql_fetch_assoc($res1))
  	{
  		echo "<table border=2 class='table-course'>";
  		echo "<tr align='center'><th colspan='2' >$data1[SemName]</th></tr>";
  		echo "<tr align='center'><th>No</th><th>Subject</th></tr>";
  		$qry2="select * from Subject where SemId='$data1[SemId]'";
  		if($res2=mysql_query($qry2))
  		{
  			...
  			while($data2=mysql_fetch_assoc($res2))
  			{
  				...
  				echo "<td align='center'>$data2[SubName]</td></tr>";
  			}
  		}
  		else
  		{
  			echo "<tr><td colspan='2'>No DATA AVAILABALE</td></tr>";
  		}
  			echo "</table>";
  	}
  }
