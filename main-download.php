...
<body onload="download();">
	...
	<!-- Navigation Bar -->
        ...
        <div class="dropdown-menu bg-dark" id="show" aria-labelledby="navbarDropdown">
          <?php
          ...
          {
            echo "<a  class='dropdown-item link text-white' href='main-course.php?id=$data[DegId]'>$data[DegName]</a>";
          }
          ?>
        </div>
        </li>
...
<div id="content" style="margin-top:7%; width:99%;"></div>
